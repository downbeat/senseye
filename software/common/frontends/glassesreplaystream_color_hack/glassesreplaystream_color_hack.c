//**************************************************************************************************
// Utility to replay a glasses capture log, but forked and modified to support color images.
...
//
//
// A hacked version of the iglasses replay utility which supports color images.
//
// Runs on the glasses data exchange format (GDF) v0.
//
//
// AUTHORS
