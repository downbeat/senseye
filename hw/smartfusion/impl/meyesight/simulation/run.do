...
quietly set PROJECT_DIR "Z:/russ/private/research/insight/git/hw/smartfusion/impl/meyesight"
onerror { quit -f }
onbreak { quit -f }
...
if {[file exists ../component/Actel/DirectCore/CoreAPB3/3.0.103/mti/user_vlog/COREAPB3_LIB/_info]} {
   echo "INFO: Simulation library ../component/Actel/DirectCore/CoreAPB3/3.0.103/mti/user_vlog/COREAPB3_LIB already exists"
} else {
   vlib ../component/Actel/DirectCore/CoreAPB3/3.0.103/mti/user_vlog/COREAPB3_LIB
}
