...
#define FRAMEW RESOLUTION_WIDTH
#define FRAMEH RESOLUTION_HEIGHT
...
void on_mouse_scene( int event, int x, int y, int flags, void *params )
{
   int i;
...
void on_mouse_eye( int event, int x, int y, int flags, void *params )
{
   int i;
   static bool start = 0;
...
{
  uyyvyy2rgb((unsigned char *)FirewireFrame, (unsigned char *)OpenCV_image->imageData, RESOLUTION_WIDTH*RESOLUTION_HEIGHT);
}
