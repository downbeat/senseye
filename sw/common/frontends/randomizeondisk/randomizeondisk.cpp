//**************************************************************************************************
// Utility to create a (out of order) capture log by randomizing the order of an input capture log.
...
//
// Utility to create a (out of order) capture log by randomizing the order of an input capture log.
// Utility for trying different gaze prediction algorithms by modifying the source code.
//
// Uses the glasses data exchange format (GDF) v0.
//
//
// AUTHORS
