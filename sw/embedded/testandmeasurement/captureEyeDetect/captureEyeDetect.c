...
//   (void)fgets(indat,3,camin);
   ...
   while(1)
   {
      ...
      *indatloc = '\0';
      ...
      cvThreshold(inverted, threshed, ED_THRESHOLD, 255, CV_THRESH_BINARY_INV);

      cvShowImage("CamCap", framescaledup);
      cvShowImage("CamCapSmall", framenorm);
      cvShowImage("EyeDetectSmall", threshed);
   ...
   cvDestroyWindow("EyeDetectSmall");
