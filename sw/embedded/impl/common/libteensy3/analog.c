...
void analog_init(void)
{
	...
	// FIXME russ: check F_BUS!
	ADC0_CFG1 = ADC_CFG1_ADIV(2) + ADC_CFG1_ADLSMP + ADC_CFG1_MODE(3) + ADC_CFG1_ADICLK(1);
/* russ: removed by me
#if F_BUS == 48000000
...
*/
	//return;
	// TODO russ: make it got faster!
	// ADC0_CFG2 = ADC_CFG2_MUXSEL + ADC_CFG2_ADHSC;// + ADC_CFG2_ADLSTS(3);
